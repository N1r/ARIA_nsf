...
from aris.models.ctrl import wrap_ctrl_fn, Controllable
from aris.models.filters import LTVFilterInterface, LTVMinimumPhaseFilterPrecise
from aris.models.synth import OscillatorInterface
from aris.models.utils import biquads2lpc, get_logits2biquads, fir_filt
...
class AnalyticHarmonicsOscillator(OscillatorInterface):
    ...
    Integrate into HarmonicPlusNoiseSynth as harm_oscillator:
      harm_oscillator:
        class_path: aris.models.analytic_filter.AnalyticHarmonicsOscillator
        init_args:
          sr: 16000
          n_harmonics: 80
    """
