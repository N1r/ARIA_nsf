...
def get_f0(*args, **kwargs):
    """Run WORLD DIO only when this legacy helper is explicitly used."""
    try:
        import pyworld as pw
    except ImportError as error:
        raise ImportError(
            "The optional WORLD F0 helper requires: pip install 'phonlab-ddsp[world]'"
        ) from error
    defaults = {
        "f0_ceil": 1047,
