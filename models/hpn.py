...
class HarmonicPlusNoiseSynth(Synth):
    ...
    def forward(
        ...
        **other_params
        ...
        # Voiced gate on the OUTPUT (not phase): silences unvoiced harmonics.
        # Gating phase would zero it and break AdditiveSynthesizer's 0.5/phase,
        # and would defeat AnalyticHarmonicsOscillator's f0>0 mask under filled phase.
